...
// Tuplas [cargo, empresa, cita]. Sanity (build) reemplaza la lista si la provee.
const fallback = [
...
export const testimonials = generated.testimonials?.length ? generated.testimonials : fallback;
